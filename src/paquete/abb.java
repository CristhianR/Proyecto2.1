...
public class abb {
    ...
    public class nodoArbol { //Clase nodo con constructor
        private abb hd;
        private abb hi;
        private int dato;
        private Object val;
   ...
   public boolean existeBoolean(int a){ //Comprueba si existe el valor a en un arbol
    if (!esVacio()) { //si no es vacio
            if (a == raiz.dato) { //si el valor de a es igual al dato de la raiz
            return true;
            }
                ...
                if (a < raiz.dato) { //si el valor de a es menor al dato de la raiz
                    raiz.hi.existeBoolean(a); // busca en el hijo derecho de la raiz
                }
                else { //si el valor de a es mayor al dato de la raiz
                    raiz.hd.existeBoolean(a); // busca en el hijo derecho de la raiz
                }
            }
        }		
        return false;
